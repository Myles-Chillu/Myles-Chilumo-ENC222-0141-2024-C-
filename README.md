...
A character stores a single character,uses 1 byte and value must be in single quotes (' ').
A string stores a sequence of characters (text),size varies depending on length and uses double quotes (" ").
